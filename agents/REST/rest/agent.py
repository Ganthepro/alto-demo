...
class Rest(Agent):
    ...
    def _handle_query_life_beings(self, env, data):
        response = self.vip.rpc.call("data_logger", "query_life_beings").get()
        return response
    
    def _send_websocket_message(self):
        response = self.vip.rpc.call("data_logger", "query_iaq").get()
        self.vip.web.send("/ws/iaq", response)
    ...
    def onstart(self, sender, **kwargs):
        ...
        self.vip.web.register_endpoint("/life_beings", self._handle_query_life_beings)
