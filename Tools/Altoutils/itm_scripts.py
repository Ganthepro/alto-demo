...
if __name__ == "__main__":
    A = ITMFCU("1", "3-08", ITMHandler("svm", "svm", "192.168.111.201", "8081"))
    print(A.get_status())
    time.sleep(5)
    print(A.set_on_off("on"))
    # time.sleep(5)
    # print(A.set_fan_direction("position_1"))
    time.sleep(7)
    print(A.get_status())
    time.sleep(5)
    print(A.set_on_off("off"))
    time.sleep(10)
    print(A.get_status())

    # B = ITMOAU("1", "4-02", ITMHandler("svm", "svm", "192.168.111.201", "8081"))
    # print(B.get_status())
    # B.set_mode("off")
    # B.get_status()