import BAC0
bacnet = BAC0.lite('192.168.2.103')
bacnet.whois()
# print(bacnet.devices)
# mycontroller = BAC0.device(bacnet)
mycontroller = BAC0.device('192.168.2.110', 110, bacnet) # (Bacnet IP, Device Instance Number (it usually be the last byte of IP address), bacnet)
# mycontroller = BAC0.device('192.168.2.110', 70000, bacnet)
# exit()
...
for i in mycontroller.points_name:
    ...
    if mycontroller[i].bacnet_properties['objectType'] == "binaryInput":
        print(mycontroller[i].bacnet_properties)
