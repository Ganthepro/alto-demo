...
for dev_id in "${arr[@]}" ; do
    ...
    sleep 1
    cat /home/alto/alto_os-brown/Agents/Room/$config_template | sed "s/atmo_device_id/$dev_id/g" | sed "s/Nnumber/$rnumber/g" | sed "s/Roomprefix/$room_id_prefix/g" | sed "s/^M//g" > /tmp/tbd
